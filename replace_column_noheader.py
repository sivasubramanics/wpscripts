...
parser = argparse.ArgumentParser(description='replace column entries in input file by the entries from lookup file')
...
with open(args.input, 'r') as f:
    for line in f:
        ...
        if data[args.column] in lookup_dict:
            data[args.column] = lookup_dict[data[args.column]]
        out_fo.write(f"{join_elements(data)}\n")
